...
const DocumentListPage = () => {
    ...
    const [isUploadModalOpen, setIsUploadOpen] = useState(false);
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center max-w-md">
                    ...
                    <h3 className="text-xl font-slate-500 mb-6">
                        No Documents Yet
                    </h3>
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-50/30 active:scale-[0.98]"
                    >
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px, transparent_1px,transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none"/>
                ...
                <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
                    ...
                    <form onSubmit={handleUpload} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:bg-emerald-50/30 transition-all duration-200">
                                <input 
                                id="file-upload"
                                type="file"
                                ...
                                <div className="flex flex-col  items-center justify-center py-10 px-6">
                                    <div className="w-14 h-14 rounded-xl bg-linear-to-r from-emerald-100 to-teal-100 items-center justify-center mb-4">
                                        <Upload
            ...
            {isDeleteModalOpen && (
                ...
                <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
                    ...
                    <div className="flex gap-3">
                        ...
                        onClick={() => setIsDeleteModalOpen(false)}
                        disabled={deleting}
                        className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-white text-slate-700 bg-white text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 disabled:opacity-50 disable:cursor-not-allowed"
                        >
                            Cancel 
                        </button>
                        <button
                        ...
                        disabled={deleting}
                        className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-white text-slate-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-red-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
                        >
                            {deleting ? (
                                <span className="flex items-center justify-center gap-2">
                                    <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"/>
